...
| **Pinned third-party content** | `vendor/ecc/ORIGIN.json` | Upstream changes are *reported* by `crossbrain drift` and never pulled in automatically. A new pin means reviewing a diff. |
